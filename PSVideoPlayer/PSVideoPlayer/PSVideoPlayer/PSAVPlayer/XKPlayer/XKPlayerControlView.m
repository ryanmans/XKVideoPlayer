...
{
    NSLog(@"%s  state : %ld",__func__,(PSPlayerControlClickState)sender.tag);
...
- (void)setTimeText:(NSString *)timeText
{
    ...
    XKPlayerControlView * playerView = (XKPlayerControlView*)self.superview;
...
@implementation XKPlayerControlView
...
- (void)layoutSubviews
{
    ...
    [self.lockButton setLayerRadius:self.lockButton.width / 2];
